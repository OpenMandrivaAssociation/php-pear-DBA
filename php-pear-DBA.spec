...
install -d %{buildroot}%{_datadir}/pear/%{_class}/Driver

install %{_class}-%{version}/%{_class}.php %{buildroot}%{_datadir}/pear
install %{_class}-%{version}/%{_class}/*.php %{buildroot}%{_datadir}/pear/%{_class}
install %{_class}-%{version}/%{_class}/Driver/* %{buildroot}%{_datadir}/pear/%{_class}/Driver
...
%dir %{_datadir}/pear/%{_class}/Driver
%{_datadir}/pear/*.php
%{_datadir}/pear/%{_class}/*.php
%{_datadir}/pear/%{_class}/Driver/*
